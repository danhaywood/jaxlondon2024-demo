package petclinicapp.modules.petowner.dom.petowner;
...
import petclinicapp.modules.petowner.dom.pet.PetSpecies;
import petclinicapp.modules.petowner.types.Name;
import petclinicapp.modules.petowner.types.Notes;
import petclinicapp.modules.petowner.types.PetName;
import petclinicapp.modules.petowner.types.PhoneNumber;
import petclinicapp.modules.petowner.value.EmailAddress;
...
public class PetOwner implements Comparable<PetOwner>, CalendarEventable {
    ...
    public void delete() {
        ...
        messageService.informUser("'%s' deleted".formatted(title));
